package com.lakecloud.core.constant;

/**
 * 
* <p>Title: Globals.java</p>

* <p>Description: 系统常量类，这里的常量是系统默认值，可以在系统中进行用户定制</p>
...
public class Globals {
	public final static String DEFAULT_SYSTEM_TITLE = "LakeCloud多用户商城系统";// 系统默认名称
	public final static boolean SSO_SIGN = false;// 是否允许单点登录，店铺二级域名开启
	public final static int DEFAULT_SHOP_VERSION = 20140301;// 软件发布小版本号
	public final static String DEFAULT_SHOP_OUT_VERSION = "V1.4";// 软件大版本号
	public final static String DEFAULT_WBESITE_NAME = "LakeCloud";// 软件名称
	...
	public final static String DEFAULT_TABLE_SUFFIX = "LakeCloud_";// 默认表前缀名
	public final static String THIRD_ACCOUNT_LOGIN = "LakeCloud_third_login_";// 第三方账号登录的前缀
