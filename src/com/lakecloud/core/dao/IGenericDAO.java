package com.lakecloud.core.dao;
...
/**
 * 
* <p>Title: IGenericDAO.java</p>

* <p>Description: 系统泛型DAO基础接口，所有POJO的DAO均需继承该接口，POJO接口无需编写任何方法，通过接口编程完成POJO的注入</p>
...
public interface IGenericDAO<T> {
	 ...
	 *            obj.userRole=:role
	 * @param params
	 *            查询语句中的参数，使用Map传递，结合查询语句中的参数命名来确定 
	 *            Map map=new HashMap();
	 *            map.put("id",id);
	 *            map.put("role",role); 
	 *            该方法的使用方法为:
