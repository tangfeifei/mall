...
import com.lakecloud.core.tools.HttpInclude;
import com.lakecloud.foundation.domain.SysConfig;
import com.lakecloud.foundation.domain.UserConfig;

/**
 * 
* <p>Title: JModelAndView.java</p>

* <p>Description: 顶级视图管理类，封装ModelAndView并进行系统扩展</p>
...
public class JModelAndView extends ModelAndView {
	...
	public JModelAndView(String viewName, SysConfig config, UserConfig uconfig,
		...
		super.addObject("CURREQUEST" ,request);//
	}
