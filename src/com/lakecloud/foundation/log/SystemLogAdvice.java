package com.lakecloud.foundation.log;
...
public class SystemLogAdvice {
	...
	// 记录用户操作日志
	@AfterReturning(value = "execution(* com.lakecloud.manage..*.*(..))&& @annotation(annotation)&&args(request,..) ")
	...
	// 异常日志记录
	@AfterThrowing(value = "execution(* com.lakecloud.manage..*.*(..))&&args(request,..) ", throwing = "exception")
