...
public class BaseManageAction {
	...
	public void login_success(HttpServletRequest request,
		...
		if (Globals.SSO_SIGN
			...
			// 获取密匙数据
			Cookie lakecloud_user_session = new Cookie("lakecloud_user_session",
					user.getId().toString());
			lakecloud_user_session.setDomain(CommUtil.generic_domain(request));
			// lakecloud_user_session.setMaxAge(60 * 20);
			response.addCookie(lakecloud_user_session);
		}
	...
	public void user_msg_save(HttpServletResponse response, String msg)
		...
		PostMethod method = new PostMethod(
				"http://www.chinacloud.net/user_msg.htm");
