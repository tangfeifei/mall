...
import com.lakecloud.foundation.domain.query.SpareGoodsFloorQueryObject;
...
public class SpareGoodsFloorManageAction {
	...
	public ModelAndView floor_list(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView(
				"admin/blue/sparegoodsfloor_list.html", configService
						.getSysConfig(),
	...
	public ModelAndView floor_add(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView(
				"admin/blue/sparegoodsfloor_add.html", configService
						.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
	...
	public ModelAndView floor_save(HttpServletRequest request,
		...
		if (id.equals("")) {
			sparegoodsfloor = wf.toPo(request, SpareGoodsFloor.class);
		...
		try {
			...
			if (fileName.equals("")) {
				if (map.get("fileName") != "") {
					...
					advert_img.setName(CommUtil
							.null2String(map.get("fileName")));
	...
	public String floor_delete(HttpServletRequest request,
		...
		for (String id : ids) {
			if (!id.equals("")) {
				SpareGoodsFloor sparegoodsfloor = this.sparegoodsfloorService
						.getObjById(Long.parseLong(id));
				this.sparegoodsfloorService.delete(Long.parseLong(id));
			}
		}
	...
	public ModelAndView floor_setclass(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView(
				"admin/blue/sparegoodsfloor_setclass.html", configService
						.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		...
		SpareGoodsFloor sgf = this.sparegoodsfloorService.getObjById(CommUtil
				.null2Long(fid));
		Set<Long> ids = this.getSpareGoodsClassChildIds(sgf.getSgc());
		Map map = new HashMap();
		map.put("ids", ids);
	...
	public ModelAndView floor_setgoods(HttpServletRequest request,
			...
			String orderType, String fid) {
		ModelAndView mv = new JModelAndView(
				"admin/blue/sparegoodsfloor_setgoods.html", configService
						.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		SpareGoodsFloor sgf = this.sparegoodsfloorService.getObjById(CommUtil
				.null2Long(fid));
		...
		qo.addQuery("obj.down", new SysMap("obj_down", 0), "=");
