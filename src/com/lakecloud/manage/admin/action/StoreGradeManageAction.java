...
import com.lakecloud.foundation.domain.query.StoreGradeQueryObject;
...
public class StoreGradeManageAction {
	...
	public void storegrade_ajax(HttpServletRequest request, HttpServletResponse response,
	...
	public ModelAndView storegrade_template(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView(
				"admin/blue/storegrade_template.html", configService
						.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		mv.addObject("path", request.getRealPath("/"));
		mv.addObject("obj", this.storegradeService.getObjById(Long
				.parseLong(id)));
