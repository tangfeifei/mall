...
import com.lakecloud.foundation.domain.query.GoodsReturnQueryObject;
...
public class GoodsReturnSellerAction {
	...
	public ModelAndView refund(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView(
				"user/default/usercenter/goods_return.html", configService
						.getSysConfig(),
	...
	public ModelAndView return_view(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView(
				"user/default/usercenter/return_view.html", configService
						.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		GoodsReturn obj = this.goodsReturnService.getObjById(CommUtil
				.null2Long(id));
